...
PRESETS: Dict[str, DemoScopePreset] = {
    "fast": DemoScopePreset(
        key="fast",
        label="Tuscaloosa county, AL — 2026-02-18 end-to-end (PDF + video)",
        eta="~45–75 min",
        max_states=1,
        max_jurisdictions=1,
        meeting_dates=1,
    ...
    "fast_bigtimber": DemoScopePreset(
        key="fast_bigtimber",
        label="Big Timber municipality, MT — 2026-04-06 end-to-end (PDF + video)",
        eta="~45–75 min",
        max_states=1,
        max_jurisdictions=1,
        meeting_dates=1,
        ...
        parallel_states=1,
        max_images_per_jur=0,
        preferred_jurisdiction_slug="municipality_3006475",
        pinned_meeting_date="2026-04-06",
        default_media_scope="all",
    ),
...
def normalize_scope_key(raw: str) -> str:
    ...
    aliases = {
        ...
        "alabama": "fast",
        "al": "fast",
        "bigtimber": "fast_bigtimber",
        "montana": "fast_bigtimber",
        "mt": "fast_bigtimber",
        "2026_04_06": "fast_bigtimber",
        "2": "medium",
        "two": "medium",
        "standard": "medium",
        "4": "full",
